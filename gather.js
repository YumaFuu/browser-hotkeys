...
e.appendChild(document.createElement('br'));
e.appendChild(teleportButton('o-1', 78, 34));
e.appendChild(teleportButton('o-2', 74, 34));
e.appendChild(teleportButton('o-3', 76, 31));
e.appendChild(teleportButton('o-4', 72, 31));
e.appendChild(teleportButton('o-5', 78, 23));
e.appendChild(teleportButton('o-6', 74, 23));
